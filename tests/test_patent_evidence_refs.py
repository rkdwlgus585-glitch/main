...
EVIDENCE_EXPECTATIONS: dict[str, str] = {
    # Track A
    "yangdo_blackbox_api.py:779": "_estimate_response_tier",
    "core_engine/yangdo_listing_recommender.py:496": "build_recommendation_bundle",
    "yangdo_blackbox_api.py:1168": "def estimate",
    "yangdo_blackbox_api.py:1087": "usage_snapshot",
    # Track B
    ...
    "permit_precheck_api.py:1316": "do_POST",
    ...
    "yangdo_blackbox_api.py:1358": "_graceful_shutdown",
    "permit_precheck_api.py:1497": "_graceful_shutdown",
    "yangdo_consult_api.py:1071": "_graceful_shutdown",
