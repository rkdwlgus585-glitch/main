...
- `wp_cx_guard.contract.json` validates WordPress/RankMath/CX guard scripts and warns when latest guard reports (`site_cx_probe`, `site_cx_autoheal`, `site_dom_snapshot`, `site_cx_health_rollup`, `site_cx_health_digest`, `site_cx_force_recover`) are stale or unhealthy.
