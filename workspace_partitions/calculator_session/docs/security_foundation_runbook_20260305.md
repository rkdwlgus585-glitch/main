...
11. 외부 API 직접 연계(선택):
- `MONTHLY_REHEARSAL_TICKET_API_ENABLED=true`
- `MONTHLY_REHEARSAL_TICKET_API_URL`, `MONTHLY_REHEARSAL_TICKET_API_TOKEN`
- `MONTHLY_REHEARSAL_CALENDAR_API_ENABLED=true`
- `MONTHLY_REHEARSAL_CALENDAR_API_URL`, `MONTHLY_REHEARSAL_CALENDAR_API_TOKEN`
12. md를 못 보는 환경이면 요약 텍스트 실행:
- `open_ops_snapshot.bat`
- 결과 파일: `logs/ops_snapshot_latest.txt`
