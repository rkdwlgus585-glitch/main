...
const operations: Array<{
  ...
  {
    title: "면허 거래 상담",
    body: "AI 산정 결과를 바탕으로 면허 거래 조건과 가격 협상을 전문 행정사가 1:1로 도와드립니다.",
    icon: Landmark,
  },
  {
    title: "면허 취득 컨설팅",
  ...
  {
    title: "법인·구조 점검",
    body: "법인 설립, 구조 변경, 재무 정리 등 면허 거래에 필요한 부수 절차까지 안내합니다.",
    icon: ShieldCheck,
  },
  {
    title: "서류·절차 안내",
    body: "면허 양도 계약서, 등록 서류, 관할 기관 접수까지 필요한 절차를 안내합니다.",
    icon: FileText,
  },
];
